...
public:
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flDetonateTime;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_fireCount;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_fireXDelta;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_fireYDelta;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_fireZDelta;
    ...
    void init( ) {
        ...
        INIT_XOREDNETVAR(m_flDetonateTime, HASH("CBaseCSGrenadeProjectile"), HASH("m_flDetonateTime"));
        INIT_XOREDNETVAR(m_fireCount, HASH("DT_Inferno"), HASH("m_fireCount"));
        INIT_XOREDNETVAR(m_fireXDelta, HASH("DT_Inferno"), HASH("m_fireXDelta"));
        INIT_XOREDNETVAR(m_fireYDelta, HASH("DT_Inferno"), HASH("m_fireYDelta"));
        INIT_XOREDNETVAR(m_fireZDelta, HASH("DT_Inferno"), HASH("m_fireZDelta"));
